...
percentage_palette_1 <- colorNumeric("YlOrRd", pin_nbhd$primary_mode_percentage)
percentage_palette_2 <- colorNumeric("Blues", pin_nbhd$secondary_mode_percentage)
factor_colors <- colorFactor(brewer.pal(n = 8, name = "Set3"),
  domain = unique(c(pin_nbhd$primary_mode, pin_nbhd$secondary_mode))
)

leaflet(pin_nbhd) %>%
  addProviderTiles("CartoDB.Positron") %>%
  addPolygons(
    fillColor = ~ percentage_palette_1(primary_mode_percentage),
    fillOpacity = 0.7,
    color = "black",
    weight = 1,
    popup = ~ paste0(
  ...
  addLegend(
    ...
    pal = percentage_palette_1,
    values = ~primary_mode_percentage,
    title = "Primary Mode Percentage",
    opacity = 0.7
  )
```
...
leaflet(pin_nbhd) %>%
  addProviderTiles("CartoDB.Positron") %>%
  addPolygons(
    fillColor = ~ percentage_palette_2(secondary_mode_percentage),
    fillOpacity = 0.7,
    color = "black",
    weight = 1,
    popup = ~ paste0(
  ...
  addLegend(
    position = "bottomright",
    pal = percentage_palette_2,
    values = ~secondary_mode_percentage,
    title = "Secondary Mode Percentage",
    opacity = 0.7
  )
```
...
factor_colors <- colorFactor(brewer.pal(n = 8, name = "Set3"),
  domain = unique(c(pin_nbhd$mode_1, pin_nbhd$mode_2))
)

leaflet(pin_nbhd) %>%
  addProviderTiles("CartoDB.Positron") %>%
  addPolygons(
    fillColor = ~ factor_colors(primary_mode),
    fillOpacity = 0.7,
    color = "black",
    weight = 1,
    popup = ~ paste0(
...
leaflet(pin_nbhd) %>%
  addProviderTiles("CartoDB.Positron") %>%
  addPolygons(
    fillColor = ~ factor_colors(secondary_mode),
    fillOpacity = 0.7,
    color = "black",
    weight = 1,
    popup = ~ paste0(
